...
locals {
  ...
  k8s_version           = var.yc_k8_v            # Set the Kubernetes version.
  zone_a_v4_cidr_blocks = "10.1.0.0/16" # Set the CIDR block for subnet.
  sa_name               = var.yc_sa_name            # Set the service account name.
  registry_name         = "nitlab"            # Set the name of Yandex Container Registry.
}
...
resource "yandex_vpc_security_group_rule" "g5050" {
